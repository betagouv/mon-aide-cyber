...
export type TitresSEO = Exclude<Titres, 'Guide des Aidants cyber'>;

const metadonneesSelonTitre: Record<TitresSEO, string> = {
  Accueil:
...
export function useDonneesSEO(titre: TitresSEO | undefined) {
  useEffect(() => {
    if (titre) {
