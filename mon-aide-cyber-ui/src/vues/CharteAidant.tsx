          ...
          <div className="fr-grid-row fr-grid-row--gutters">
            ...
            >
              ...
              <p>
                ...
                diagnostic et un point d’étape à 6 mois (si l’entité le
              ...
              <ul>
                <li>
                  Être d’une posture bienveillante, constructive et faisant
                ...
                <li>
                  ...
                  infrastructures, sensibilisation, détection et réaction à une
                  cyberattaque),
                </li>
                <li>
                  Restituer les résultats du diagnostic et les 6 mesures de
                  sécurité prioritaires recensées et conseillées à être menées
                  sur les 6 prochains mois,
                </li>
                <li>
                  Mettre à disposition de l’entité les ressources et les
                  contacts utiles recensée par MonAideCyber,
                </li>
                <li>
                  Proposer d’effectuer à l’entité à un point de suivi 6 mois
                  après le diagnostic.
                </li>
              </ul>
              ...
              <p>
                ...
                Je ne profite pas de ma position dominante. Je n’accepte aucun
                avantage, ni aucun présent directement ou indirectement lié à ma
                fonction ou proposé au motif, réel ou supposé, d’une décision
              ...
              <p>
                ...
                l’occasion de l’exercice de mon rôle d’aidants MonAideCyber. Je
              ...
              <p>
                ...
                MonAideCyber, à la désactivation voire suppression de mes accès
                au service MonAideCyber.
              </p>
