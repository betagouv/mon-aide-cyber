        ...
        <div className="fr-container">
          <div className="fr-grid-row fr-grid-row--center">
            <div className="fr-col-8" id="top">
              ...
              <p>
                Vincent Strubel, directeur général de l&apos;ANSSI. La
                conception éditoriale, le suivi et les mises à jour du site
                internet sont assurés par les services de l&apos;ANSSI.
              </p>
              <h3>Hébergement</h3>
              <p>
                L&apos;hébergement du site est assuré par 3DS OUTSCALE
                SecNumCloud et SCALINGO, 15 avenue du Rhin, 67100 Strasbourg,
                société par actions simplifiée, immatriculée au RCS de
                Strasbourg sous le numéro 808 665 483.
              </p>
              <p>
