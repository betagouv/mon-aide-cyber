              ...
              <div className="fr-col-offset-2 fr-footer__body">
                ...
                <div className="fr-footer__content fr-col-offset-2--right">
                  <p className="fr-footer__content-desc">
                    ...
                    sensibilisées à la sécurité informatique à passer à
                    l’action. Le dispositif MonAideCyber est développé par
                    l&apos;Agence nationale de la sécurité des systèmes
                    d&apos;information, en lien avec BetaGouv et la Direction
