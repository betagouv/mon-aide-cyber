...
export async function up(knex: Knex): Promise<void | number[]> {
  const serviceChiffrement = adaptateurServiceChiffrement();
          ...
          .update({
            donnees: {
              ...
              preferences: {
                ...
                nomAffichageAnnuaire: serviceChiffrement.chiffre(
                  formatteLeNomPrenomSelonRegleAffichage(
                    serviceChiffrement.dechiffre(ligne.donnees.nomPrenom),
