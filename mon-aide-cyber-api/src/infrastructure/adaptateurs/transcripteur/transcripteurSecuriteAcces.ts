...
export const transcripteurSecuriteAcces: Thematique = {
  ...
  localisationIconeNavigation: '/images/diagnostic/securite-acces/icone-navigation.svg',
  localisationIllustration: '/images/diagnostic/securite-acces/illustration.svg',
  groupes: [
    {
