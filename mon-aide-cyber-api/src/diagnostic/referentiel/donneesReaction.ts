  ...
  questions: [
    {
      ...
      reponsesPossibles: [
        {
          identifiant: 'reaction-surveillance-veille-vulnerabilites-potentielles-nsp',
          libelle: 'Je ne sais pas',
          ordre: 0,
        },
        {
          identifiant: 'reaction-surveillance-veille-vulnerabilites-potentielles-non',
          libelle: 'Non',
          resultat: {
            indice: { valeur: 0 },
            mesures: [
        ...
        {
          identifiant: 'reaction-surveillance-veille-vulnerabilites-potentielles-veille-ponctuelle',
        ...
        {
          identifiant: 'reaction-surveillance-veille-vulnerabilites-potentielles-veille-reguliere',
    ...
    },
    {
      ...
      reponsesPossibles: [
        ...
        },
        {
          ...
          resultat: {
            ...
            mesures: [
              ...
              {
                identifiant: 'reaction-sauvegardes-donnees-realisees-oui-ponctuellement-tiroir-environnement-isole',
                niveau: 1,
              },
              {
                identifiant:
        ...
        {
          identifiant: 'reaction-sauvegardes-donnees-realisees-oui-ponctuellement',
          ...
          questions: [
            ...
            },
            {
              identifiant:
                'reaction-sauvegardes-donnees-realisees-oui-ponctuellement-tiroir-sauvegarde-testee-regulierement',
              libelle: 'Si "Oui" : La restauration de toutes les sauvegardes est-elle testée régulièrement ?',
              poids: 3,
              reponsesPossibles: [
                {
                  identifiant:
        ...
        {
          identifiant: 'reaction-sauvegardes-donnees-realisees-oui-automatique-et-reguliere',
          libelle: 'Des sauvegardes des données sont réalisées de manière automatique et régulière',
          questions: [
            {
              identifiant:
    ...
    },
    {
      ...
      libelle: 'Un dispositif de gestion de crise adapté au risque de cyberattaques a-t-il été défini ?',
      poids: 3,
      reponsesPossibles: [
        {
        ...
        {
          identifiant: 'reaction-dispositif-gestion-crise-adapte-defini-oui-fiche-reflexe',
        ...
        {
          identifiant: 'reaction-dispositif-gestion-crise-adapte-defini-oui-organisation-gestion-crise-definie',
          libelle: "Oui, une organisation de gestion de crise d'origine cyber a été définie",
          resultat: { indice: { valeur: 3 } },
          ordre: 3,
        },
      ],
