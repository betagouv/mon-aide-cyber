  ...
  questions: [
    {
      ...
      reponsesPossibles: [
        {
          identifiant: 'securite-poste-maj-fonctionnelles-et-securite-deployees-nsp',
          libelle: 'Je ne sais pas',
          ordre: 1,
        },
        {
          identifiant: 'securite-poste-maj-fonctionnelles-et-securite-deployees-non',
          libelle: 'Non',
          resultat: {
            indice: { valeur: 0 },
            mesures: [
        ...
        {
          identifiant: 'securite-poste-maj-fonctionnelles-et-securite-deployees-systematiquement-avec-exceptions',
          libelle:
        ...
        {
          identifiant: 'securite-poste-maj-fonctionnelles-et-securite-deployees-systematiquement-des-que-disponibles',
          libelle:
    ...
    {
      identifiant: 'securite-poste-si-industriel-maj-fonctionnelles-et-securite-deployees',
      libelle:
      ...
      reponsesPossibles: [
        ...
        {
          identifiant: 'securite-poste-si-industriel-maj-fonctionnelles-et-securite-deployees-nsp',
          libelle: 'Je ne sais pas',
          ordre: 1,
        },
        {
          identifiant: 'securite-poste-si-industriel-maj-fonctionnelles-et-securite-deployees-non',
          libelle: 'Non',
          resultat: {
            indice: { valeur: 0 },
            mesures: [
    ...
    },
    {
      ...
      libelle: 'Un antivirus à jour est-il déployé sur chaque poste de travail ?',
      poids: 3,
      reponsesPossibles: [
        {
        ...
        {
          identifiant: 'securite-poste-antivirus-deploye-oui-alertes-pas-toujours-traitees',
        ...
        {
          identifiant: 'securite-poste-antivirus-deploye-oui-alertes-toujours-traitees',
    ...
    },
    {
      ...
      reponsesPossibles: [
        ...
        {
          identifiant: 'securite-poste-si-industriel-antivirus-deploye-oui-alertes-pas-toujours-traitees',
          libelle: 'Oui, mais ses alertes ne sont pas toujours traitées',
          resultat: {
            indice: { valeur: 2 },
            mesures: [
        ...
        {
          identifiant: 'securite-poste-si-industriel-antivirus-deploye-oui-alertes-toujours-traitees',
          libelle: 'Oui et ses alertes sont systématiquement traitées.',
          resultat: { indice: { valeur: 3 } },
          ordre: 4,
        },
    ...
    },
    {
      ...
      libelle: "En complément de l'antivirus, un outil de type EDR a-t-il été mis en place ?",
      poids: 2,
      reponsesPossibles: [
        {
        ...
        {
          identifiant: 'securite-poste-outils-complementaires-securisation-oui-outil-complementaire-type-edr',
          libelle: 'Oui, un outil de type EDR a été mis en place mais ses alertes ne sont pas toujours traitées.',
          resultat: {
            indice: { valeur: 1 },
            mesures: [
              {
        ...
        {
          identifiant: 'securite-poste-outils-complementaires-securisation-oui-outil-complementaire-type-edr',
          libelle: 'Oui, un outil de type EDR a été mis en place et ses alertes sont systématiquement traitées',
          resultat: { indice: { valeur: 3 } },
          ordre: 3,
        },
      ],
    ...
    },
    {
      ...
      libelle: "Si entité à risque d'espionnage ciblé, les disques durs des matériels nomades sont-ils chiffrés ?",
      poids: 2,
      reponsesPossibles: [
        {
