  ...
  'reaction-sauvegardes-donnees-realisees-oui-ponctuellement-tiroir-sauvegarde-testee-regulierement':
    {
      niveau1: {
        titre:
          "Disposer d'une sauvegarde des données critiques stockées dans un environnement sécurisé, isolé de l'environnement bureautique",
        pourquoi:
  ...
  'reaction-sauvegardes-donnees-realisees-oui-automatique-et-reguliere-tiroir-sauvegarde-testee-regulierement':
    {
      niveau1: {
        titre:
          "Procéder régulièrement à des tests de restauration des données critiques",
        pourquoi:
