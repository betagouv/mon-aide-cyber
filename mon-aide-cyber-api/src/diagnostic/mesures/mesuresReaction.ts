export const mesuresReaction = {
  'reaction-surveillance-veille-vulnerabilites-potentielles': {
    niveau1: {
      ...
      pourquoi: '../../mesures/reaction/reaction-surveillance-veille-vulnerabilites-potentielles-niveau1-pourquoi.pug',
      comment: '../../mesures/reaction/reaction-surveillance-veille-vulnerabilites-potentielles-niveau1-comment.pug',
    },
    niveau2: {
      titre: 'Réaliser une veille proactive des vulnérabilités informatiques',
      pourquoi: '../../mesures/reaction/reaction-surveillance-veille-vulnerabilites-potentielles-niveau2-pourquoi.pug',
      comment: '../../mesures/reaction/reaction-surveillance-veille-vulnerabilites-potentielles-niveau2-comment.pug',
    },
    priorisation: 32,
  },
  'reaction-sauvegardes-donnees-realisees': {
    niveau1: {
      ...
      pourquoi: '../../mesures/reaction/reaction-sauvegardes-donnees-realisees-niveau1-pourquoi.pug',
      comment: '../../mesures/reaction/reaction-sauvegardes-donnees-realisees-niveau1-comment.pug',
    },
    priorisation: 6,
  },
  ...
  'reaction-sauvegardes-donnees-realisees-oui-ponctuellement-tiroir-sauvegarde-testee-regulierement': {
    niveau1: {
      titre: 'Procéder régulièrement à des tests de restauration des sauvegardes',
      pourquoi:
  ...
  'reaction-dispositif-gestion-crise-adapte-defini': {
    niveau1: {
      titre: 'Lister les personnes à contacter en cas d’incident de sécurité informatique',
      pourquoi: '../../mesures/reaction/reaction-dispositif-gestion-crise-adapte-defini-niveau1-pourquoi.pug',
      comment: '../../mesures/reaction/reaction-dispositif-gestion-crise-adapte-defini-niveau1-comment.pug',
    },
    niveau2: {
      titre: 'Définir des premières mesures organisationnelles de gestion de crise cyber',
      pourquoi: '../../mesures/reaction/reaction-dispositif-gestion-crise-adapte-defini-niveau2-pourquoi.pug',
      comment: '../../mesures/reaction/reaction-dispositif-gestion-crise-adapte-defini-niveau2-comment.pug',
    },
    priorisation: 22,
  },
};
