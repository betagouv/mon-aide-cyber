export const mesuresSecuriteInfrastructure = {
  'securite-infrastructure-pare-feu-deploye': {
    niveau1: {
      titre: 'Déployer un pare-feu physique pour protéger l’interconnexion du SI à Internet',
      pourquoi: '../../mesures/infras/securite-infrastructure-pare-feu-deploye-niveau1-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-pare-feu-deploye-niveau1-comment.pug',
    },
    priorisation: 21,
  },
  ...
  'securite-infrastructure-pare-feu-deploye-logs-stockes': {
    niveau1: {
      ...
      pourquoi: '../../mesures/infras/securite-infrastructure-pare-feu-deploye-logs-stockes-niveau1-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-pare-feu-deploye-logs-stockes-niveau1-comment.pug',
    },
    priorisation: 33,
  },
  'securite-infrastructure-si-industriel-pare-feu-deploye': {
    niveau1: {
      titre: 'Fermer tous les flux et les ports non strictement nécessaires aux systèmes industriels',
      pourquoi: '../../mesures/infras/securite-infrastructure-si-industriel-pare-feu-deploye-niveau1-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-si-industriel-pare-feu-deploye-niveau1-comment.pug',
    },
    niveau2: {
      titre:
        'Dans la mesure du possible et si non nécessaire, séparer le réseau industriel du réseau bureautique interne',
      pourquoi: '../../mesures/infras/securite-infrastructure-si-industriel-pare-feu-deploye-niveau2-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-si-industriel-pare-feu-deploye-niveau2-comment.pug',
    },
    priorisation: 23,
  },
  ...
  'securite-infrastructure-outils-securisation-systeme-messagerie': {
    ...
    niveau2: {
      titre: 'Mettre en œuvre des mécanismes complémentaires de protection contre les mails illégitimes',
      pourquoi:
  ...
  'securite-infrastructure-acces-wifi-securises': {
    niveau1: {
      ...
      pourquoi: '../../mesures/infras/securite-infrastructure-acces-wifi-securises-niveau1-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-acces-wifi-securises-niveau1-comment.pug',
    },
    niveau2: {
      titre: 'Mettre en place des mesures de sécurisation wifi',
      pourquoi: '../../mesures/infras/securite-infrastructure-acces-wifi-securises-niveau1-pourquoi.pug',
  ...
  'securite-infrastructure-espace-stockage-serveurs': {
    niveau1: {
      titre: 'Protéger les informations et les systèmes contre des atteintes physiques',
      pourquoi: '../../mesures/infras/securite-infrastructure-espace-stockage-serveurs-niveau1-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-espace-stockage-serveurs-niveau1-comment.pug',
    },
    niveau2: {
      titre: 'Mettre en place un système de vidéoprotection',
      pourquoi: '../../mesures/infras/securite-infrastructure-espace-stockage-serveurs-niveau2-pourquoi.pug',
      comment: '../../mesures/infras/securite-infrastructure-espace-stockage-serveurs-niveau2-comment.pug',
    },
    priorisation: 35,
  },
};
