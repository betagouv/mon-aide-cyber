export const mesuresSecuriteAcces = {
  ...
  'acces-teletravail-acces-distants-recyf': {
    niveau1: {
      ...
      pourquoi:
        '../../mesures/recyf/acces/acces-teletravail-acces-distants-recyf-niveau1-pourquoi.pug',
      comment:
        '../../mesures/recyf/acces/acces-teletravail-acces-distants-recyf-niveau1-comment.pug',
    },
    priorisation: 1,
  },
